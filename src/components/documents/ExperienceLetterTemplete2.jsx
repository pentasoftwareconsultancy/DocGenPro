...
const ExperienceLetterTemplate2 = ({ data, company }) => {
  ...
  return (
    ...
    >
      ...
      <Typography sx={{ mb: "8mm" }}></Typography>
      {/* Letter Header */}
      ...
      <Typography
        variant="body1"
        sx={{ mb: 1, textAlign: "justify", lineHeight: 1.8 }}
      >
        <strong>
      ...
      <Typography
        variant="body1"
        sx={{ mb: 3, textAlign: "justify", lineHeight: 0.5 }}
      >
      ...
      >
        ...
        has worked as {data.designation} at our esteemed organization from{" "}
      ...
      <Typography variant="body1" sx={{ mb: 1, mt: 5 }}>
        we found {himher()} responsible, enthusiastic and hardworking during{" "}
        {hisher()} working tenure . {heshe()} can prove to be an asset to any
        organization. We wish {himher()} success in {hisher()} future endeavors.
      </Typography>
